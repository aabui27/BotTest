...
Optimizado para acceso desde diferentes redes y contenedores
"""
...
app = Flask(__name__)
CORS(app, origins=['*'])  # Permitir CORS desde cualquier origen
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "timestamp": datetime.now().isoformat(),
        "service": "OKX Candlestick Chart API for n8n (Secure Network)",
        "version": "2.1.0",
        "security": "API Key authentication required",
        "network": "Optimized for container and network access",
        "endpoints": {
...
def get_network_info():
    ...
    return jsonify({
        ...
        "available_urls": [
            ...
            f"http://127.0.0.1:5004",
            f"http://{local_ip}:5004"
        ],
        "note": "Usa cualquiera de estas URLs desde n8n"
    })

if __name__ == '__main__':
    print("🌐 Iniciando API Server Seguro para n8n - Gráficos de Velas OKX (Network Optimized)")
    print("=" * 80)
    ...
    print("   GET  /network-info - Información de red")
    print()
    print("🔗 El servidor estará disponible en: http://0.0.0.0:5004")
    print("📝 Para n8n, usa: http://localhost:5004/generate-chart-image")
    print()
...
""")
    ...
    print()
    print("🌐 URLs alternativas para n8n:")
    print("   - http://localhost:5004/generate-chart-image")
    print("   - http://127.0.0.1:5004/generate-chart-image")
    print("   - http://[IP_LOCAL]:5004/generate-chart-image")
    print("=" * 80)
