#!/usr/bin/env python3
"""
API Server simplificado para generar gráficos de velas desde n8n
Usa matplotlib en lugar de plotly para mayor compatibilidad
"""
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "timestamp": datetime.now().isoformat(),
        "service": "OKX Candlestick Chart API (Matplotlib)"
    })
...
if __name__ == '__main__':
    print("🚀 Iniciando servidor API para gráficos de velas (Matplotlib)...")
